...
public class RestExceptionHandler {
    ...
    @ExceptionHandler({BadOperandException.class, MissedRightBracketException.class, MissedLeftBracketException.class, DivisionByZeroException.class, EmptyExpressionException.class, OperationExpectedException.class, OperandExpectedException.class})
